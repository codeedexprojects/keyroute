...
from admin_panel.utils import get_admin_commission_from_db
...
class BusBookingSerializer(BaseBookingSerializer):
    ...
    def create(self, validated_data):
        ...
        percent, revenue = get_admin_commission_from_db(booking.total_amount)

        AdminCommission.objects.create(
            booking_type='bus',
            booking_id=booking.id,
            trip_amount=booking.total_amount,
